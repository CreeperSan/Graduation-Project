...
__vue_options__.__file = "/media/creepersan/文件/毕业设计/Android/farm/src/NoPermissionView.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5f54bc51"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  components: { WxcResult: _weexUi.WxcResult },
  data: function data() {
    return {
      CustomSet: {
        errorPage: {
          button: '返回上一页',
          desc: '您所在的用户没有权限，请联系管理员',
          content: '权限不足',
          pic: _Res2.default.IC_FORBIDDEN
        }
      }
    };
  },
