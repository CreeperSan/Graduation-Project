...
__vue_options__.__file = "/media/creepersan/文件/毕业设计/Android/farm/src/HistoryView.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-e43f9c26"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var streamModule = weex.requireModule('stream');
...
exports.default = {
	...
	data: function data() {
		return {
			// 图片
			icRightButton: _Res2.default.IC_HISTORY,
			//　数据
			queryYear: '',
			queryMonth: '',
			queryDay: '',
	...
	methods: {
		onActionBarBack: function onActionBarBack() {
			weex.requireModule(_Module2.default.NAVIGATOR).pop();
		},
		onActionBarQueryCLick: function onActionBarQueryCLick() {
			this.isTopPopupShow = true;
		},
		onPopupOverlayTopClick: function onPopupOverlayTopClick() {
			this.isTopPopupShow = false;
		},
		onQueryData: function onQueryData() {
			var self = this;
			var queryJson = self.createQueryJson();
			console.log(queryJson);
			applicationModule.getDataBundle(function (bundle) {
				streamModule.fetch({
					method: 'POST',
					url: bundle[_Key2.default.ADDRESS] + 'api/history/',
					type: 'json',
					body: self.toParams(queryJson)
				}, function (rec) {
					console.log(rec);
					if (rec.ok) {
						//加载成功
		...
		onNextPage: function onNextPage(event) {
		...
		onPrevPage: function onPrevPage(event) {
			if (this.startPage <= 0) {
				weex.requireModule('modal').toast({
					message: '已经是第一页了'
				});
		...
		onAirTempChange: function onAirTempChange(event) {
			this.queryAirTemp = event.value;
		},
		onAirHumidityChange: function onAirHumidityChange(event) {
			this.queryAirHumidity = event.value;
		},
		onDirtTemperatureChange: function onDirtTemperatureChange(event) {
			this.queryDirtTemp = event.value;
		},
		onDirtHumidityChange: function onDirtHumidityChange(event) {
			this.queryDirtHumidity = event.value;
		},
		onLightChange: function onLightChange(event) {
			this.queryLight = event.value;
		},
		onPageCountChange: function onPageCountChange(event) {
   ...
   *	供内部调用
   */
		createQueryJson: function createQueryJson() {
			var queryJson = {};
		...
		putDataIntoJsonIfValid: function putDataIntoJsonIfValid(jsonObj, key, data) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["aboutActionBar"],
    attrs: {
      "title": "历史记录",
      "backgroundColor": "#FFFFFF",
      "textColor": "#000000",
      "useDefaultReturn": false,
      "rightButton": _vm.icRightButton
    },
    on: {
      "wxcMinibarRightButtonClicked": _vm.onActionBarQueryCLick,
      "wxcMinibarLeftButtonClicked": _vm.onActionBarBack
    }
  }), _c('wxc-popup', {
    attrs: {
      "popupColor": "#FFFFFF",
      "show": _vm.isTopPopupShow,
      "pos": "top",
      "height": "756"
    },
    on: {
      "wxcPopupOverlayClicked": _vm.onPopupOverlayTopClick
    }
  }, [_c('div', {
    staticClass: ["historyQueryDiv"]
  }, [_c('input', {
    staticClass: ["historyQueryInput"],
    attrs: {
      "placeholder": "年"
    },
    on: {
    ...
    on: {
      "change": _vm.onDirtTemperatureChange
    }
  }), _c('input', {
    staticClass: ["historyQueryInput"],
    attrs: {
    ...
    on: {
      "change": _vm.onPageCountChange
    }
  })]), _c('div', {
    staticClass: ["historyQueryDiv"]
  }, [_c('wxc-button', {
    staticClass: ["historyQueryButton"],
    attrs: {
      "text": "查询"
    },
    on: {
      "wxcButtonClicked": _vm.onQueryData
    }
  })], 1)]), _c('div', {
    staticClass: ["historyDivCenter"]
  }, [_c('image', {
    staticClass: ["historyDivCenterImage"],
    attrs: {
      "src": "http://192.168.1.106:8000/static/common/icon/ic_device.png"
    }
  }), _c('list', {
    staticClass: ["historyDivCenterList"]
  }, [_vm._m(0), _vm._l((_vm.historyData), function(item) {
    return _c('cell', {
      key: _vm.index,
      staticStyle: {
        flexDirection: "row"
      ...
      staticClass: ["historyDivCenterItem"]
    }, [_vm._v(_vm._s(item.year) + "-" + _vm._s(item.month) + "-" + _vm._s(item.day) + " " + _vm._s(item.hour) + ":" + _vm._s(item.minute) + ":" + _vm._s(item.second))]), _c('text', {
      staticClass: ["historyDivCenterItem"]
    }, [_vm._v(_vm._s(item.air_temperature) + "℃ / " + _vm._s(item.air_humidity) + "%")]), _c('text', {
      staticClass: ["historyDivCenterItem"]
    }, [_vm._v(_vm._s(item.dirt_temperature) + "℃ / " + _vm._s(item.dirt_humidity) + "%")]), _c('text', {
      staticClass: ["historyDivCenterItem"]
    }, [_vm._v(_vm._s(item.light))])])
  })], 2)]), _c('div', {
    staticClass: ["historyDivBottom"]
  }, [_c('text', {
    staticClass: ["historyDivBottomText"],
    on: {
      "click": _vm.onPrevPage
    }
  }, [_vm._v("上一页")]), _c('text', {
    staticClass: ["historyDivBottomText"]
  }, [_vm._v(_vm._s(_vm.startPage + 1) + " / " + _vm._s(_vm.pageMax))]), _c('text', {
    staticClass: ["historyDivBottomText"],
    on: {
  ...
  return _c('header', {
    ...
    staticClass: ["historyDivCenterItem", "historyWhiteBackground"]
  }, [_vm._v("时间")]), _c('text', {
    staticClass: ["historyDivCenterItem", "historyWhiteBackground"]
  }, [_vm._v("空气")]), _c('text', {
    staticClass: ["historyDivCenterItem", "historyWhiteBackground"]
