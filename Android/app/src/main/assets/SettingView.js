...
__vue_options__.__file = "/media/creepersan/文件/毕业设计/Android/farm/src/SettingView.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-1607dfa9"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var WHICH_TEMP_UP = 1;
var WHICH_TEMP_DOWN = 2;
var WHICH_AIR_HUMIDITY_UP = 3;
var WHICH_AIR_HUMIDITY_DOWN = 4;
var WHICH_DIRT_HUMIDITY_UP = 5;
var WHICH_DIRT_HUMIDITY_DOWN = 6;

var WHICH_ACTION_TEMP_UP = 1;
var WHICH_ACTION_TEMP_DOWN = 2;
var WHICH_ACTION_AIR_HUMIDITY_UP = 3;
var WHICH_ACTION_AIR_HUMIDITY_DOWN = 4;
var WHICH_ACTION_DIRT_HUMIDITY_UP = 5;
var WHICH_ACTION_DIRT_HUMIDITY_DOWN = 6;
...
exports.default = {
    components: { WxcMinibar: _weexUi.WxcMinibar, WxcCell: _weexUi.WxcCell, WxcMask: _weexUi.WxcMask, WxcStepper: _weexUi.WxcStepper },
    ...
    methods: {
        ...
        stepperValueChange: function stepperValueChange(event) {
            this.inputValue = event.value;
        },
        getBgColor: function getBgColor(isActive) {
            if (isActive) {
                return '#EEEEEE';
            } else {
                return '#FFFFFF';
        ...
        onActionTargetClick: function onActionTargetClick(pos) {
            this.actionTargetSelect = pos;
            this.actionValueSelect = 0;
        },
        onActionValueCLick: function onActionValueCLick(pos) {
        ...
        isShowActionValueOnOffState: function isShowActionValueOnOffState() {
        ...
        onCircleClick: function onCircleClick(pos) {
            this.circleTarget = pos;
        },
        refreshSettingData: function refreshSettingData() {
            var self = this;
            applicationModule.getDataBundle(function (bundle) {
                streamModule.fetch({
                    url: bundle[_Key2.default.ADDRESS] + 'api/mobile_setting/',
                    method: 'POST',
                    type: 'json'
                }, function (rec) {
        ...
        onActionSelected: function onActionSelected(which) {
        ...
        submitTemperature: function submitTemperature() {
            var self = this;
            applicationModule.getDataBundle(function (bundle) {
                streamModule.fetch({
                    url: bundle[_Key2.default.ADDRESS] + 'api/temperature/',
                    method: 'POST',
                    type: 'json',
                    body: 'is_auto_control=' + boolToInt(self.tempIsAuto) + '&upper_limit=' + self.tempUpper + '&lower_limit=' + self.tempLower + '&upper_action=' + JSON.stringify(self.tempUpperAction) + '&lower_action=' + JSON.stringify(self.tempLowerAction)
                }, function (rec) {
                    if (rec.ok) {
        ...
        submitAirHumidity: function submitAirHumidity() {
            var self = this;
            applicationModule.getDataBundle(function (bundle) {
                streamModule.fetch({
                    url: bundle[_Key2.default.ADDRESS] + 'api/humidity/',
                    method: 'POST',
                    type: 'json',
                    body: 'is_auto_control=' + boolToInt(self.airHumidityIsAuto) + '&upper_limit=' + self.airHumidityUpper + '&lower_limit=' + self.airHumidityLower + '&upper_action=' + JSON.stringify(self.airHumidityUpperAction) + '&lower_action=' + JSON.stringify(self.airHumidityLowerAction)
                }, function (rec) {
                    if (rec.ok) {
                        self.refreshSettingData();
                    } else {
        ...
        submitDirtHumidity: function submitDirtHumidity() {
            var self = this;
            applicationModule.getDataBundle(function (bundle) {
                streamModule.fetch({
                    url: bundle[_Key2.default.ADDRESS] + 'api/dirt_humidity/',
                    method: 'POST',
                    type: 'json',
                    body: 'is_auto_control=' + boolToInt(self.dirtHumidityIsAuto) + '&upper_limit=' + self.dirtHumidityUpper + '&lower_limit=' + self.dirtHumidityLower + '&upper_action=' + JSON.stringify(self.dirtHumidityUpperAction) + '&lower_action=' + JSON.stringify(self.dirtHumidityLowerAction)
                }, function (rec) {
                    if (rec.ok) {
                        self.refreshSettingData();
                    } else {
        ...
        onMaskListDataDelete: function onMaskListDataDelete(index) {
            this.actionDataList.splice(index, 1);
        },

        // 获取资源
        getTargetStr: function getTargetStr(item) {
            return ARRAY_TARGET[item.target + 1];
        },
        getOperationStr: function getOperationStr(item) {
    ...
    data: function data() {
        return {
            ...
            icHumidityDirt: _Res2.default.IC_DIRT_HUMIDITY,
            //设置参数
            tempIsAuto: false,
            tempUpper: 0,
            tempLower: 0,
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('wxc-minibar', {
    ...
    on: {
      "wxcMinibarLeftButtonClicked": _vm.onBack
    }
    ...
    staticClass: ["setting-title-div"]
  }, [_c('image', {
    staticClass: ["setting-title-img"],
    attrs: {
      "src": _vm.icTemperature
    }
  }), _c('text', {
    staticClass: ["setting-title-text"]
  }, [_vm._v("温度设置")])]), _c('wxc-cell', {
    attrs: {
      "title": "温度自动控制",
      "hasArrow": false
    }
    ...
    attrs: {
      "slot": "value",
      "checked": _vm.tempIsAuto
    },
    on: {
      "change": _vm.onTempAutoChange
    },
    slot: "value"
  })]), _c('wxc-cell', {
    attrs: {
    ...
    slot: "value"
  }, [_vm._v(_vm._s(_vm.tempUpper) + "℃")])]), _c('wxc-cell', {
    attrs: {
      "title": "温度下限",
      "hasArrow": true
    },
    ...
    slot: "value"
  }, [_vm._v(_vm._s(_vm.tempLower) + "℃")])]), _c('wxc-cell', {
    attrs: {
      "title": "温度上限执行动作",
      "hasArrow": true
    },
    ...
    attrs: {
      "slot": "value",
      "checked": _vm.airHumidityIsAuto
    },
    on: {
      "change": _vm.onAirHumidityChange
    },
    slot: "value"
  })]), _c('wxc-cell', {
    attrs: {
    ...
    slot: "value"
  }, [_vm._v(_vm._s(_vm.airHumidityUpper) + "%")])]), _c('wxc-cell', {
    attrs: {
      "title": "空气湿度下限",
      "hasArrow": true
    },
    ...
    slot: "value"
  }, [_vm._v(_vm._s(_vm.airHumidityLower) + "%")])]), _c('wxc-cell', {
    attrs: {
      "title": "空气湿度上限执行动作",
      "hasArrow": true
    },
    ...
    staticClass: ["setting-title-img"],
    attrs: {
      "src": _vm.icHumidityDirt
    }
  }), _c('text', {
    staticClass: ["setting-title-text"]
  }, [_vm._v("土壤湿度设置")])]), _c('wxc-cell', {
    attrs: {
      "title": "土壤湿度自动控制",
      "hasArrow": false
    }
    ...
    attrs: {
      "slot": "value",
      "checked": _vm.dirtHumidityIsAuto
    },
    on: {
      "change": _vm.onDirtHumidityChange
    },
    slot: "value"
  })]), _c('wxc-cell', {
    attrs: {
    ...
    slot: "value"
  }, [_vm._v(_vm._s(_vm.dirtHumidityUpper) + "℃")])]), _c('wxc-cell', {
    attrs: {
      "title": "土壤湿度下限",
      "hasArrow": true
    },
    ...
    slot: "value"
  }, [_vm._v(_vm._s(_vm.dirtHumidityLower) + "℃")])]), _c('wxc-cell', {
    attrs: {
      "title": "土壤湿度上限执行动作",
      "hasArrow": true
    },
    ...
    attrs: {
      ...
      "show": _vm.isShowAction || _vm.isShowInput
    },
    on: {
      "wxcMaskSetHidden": _vm.wxcMaskSetHidden
    }
  }, [_c('div', {
    staticClass: ["setting-mask"]
  }, [_c('text', {
    staticClass: ["setting-mask-title"]
  }, [_vm._v(_vm._s(_vm.maskTitle))]), (_vm.isShowAction) ? _c('div', {
    staticClass: ["setting-mask-content"],
    staticStyle: {
      height: "300px",
      flexDirection: "row",
      borderWidth: "1px",
    ...
    staticClass: ["setting-mask-action-list"]
  }, [_c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 0)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(0)
      }
    }
  }, [_vm._v("请选择对象")])]), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 1)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(1)
      }
    }
  }, [_vm._v("温度自动控制")])]), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 2)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(2)
      }
    }
  }, [_vm._v("空气湿度自动控制")])]), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 3)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(3)
      }
    }
  }, [_vm._v("土壤湿度自动控制")])]), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 4)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(4)
      }
    }
  }, [_vm._v("自动施肥")])]), _c('cell', {
    appendAsTree: true,
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 5)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(5)
      }
    }
  }, [_vm._v("自动浇水")])]), _c('cell', {
    appendAsTree: true,
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 6)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(6)
      }
    }
  }, [_vm._v("施肥")])]), _c('cell', {
    appendAsTree: true,
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 7)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(7)
      }
    }
  }, [_vm._v("浇水")])]), _c('cell', {
    appendAsTree: true,
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 8)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(8)
      }
    }
  }, [_vm._v("风扇")])]), _c('cell', {
    appendAsTree: true,
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 9)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(9)
      }
    }
  }, [_vm._v("电热膜")])]), _c('cell', {
    appendAsTree: true,
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 10)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(10)
      }
    }
  }, [_vm._v("自定义设备１")])]), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 11)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(11)
      }
    }
  }, [_vm._v("自定义设备２")])]), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 12)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(12)
      }
    }
  }, [_vm._v("自定义设备３")])]), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 13)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(13)
      }
    }
  }, [_vm._v("自定义设备４")])]), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 14)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(14)
      }
    }
  }, [_vm._v("环境光开关")])]), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 15)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(15)
      }
    }
  }, [_vm._v("环境光颜色")])]), _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionTargetSelect === 16)
    },
    on: {
      "click": function($event) {
        _vm.onActionTargetClick(16)
      }
    }
  }, [_vm._v("环境光亮度")])])]), (_vm.actionTargetSelect === 0) ? _c('list', {
    staticClass: ["setting-mask-action-list"]
  }, [_c('cell', {
    appendAsTree: true,
    attrs: {
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionValueSelect === 0)
    },
    on: {
      "click": function($event) {
        _vm.onActionValueCLick(0)
      }
    }
  }, [_vm._v("请先选择对象")])])]) : _vm._e(), (_vm.isShowActionValueOnOffState()) ? _c('list', {
    staticClass: ["setting-mask-action-list"]
  }, [_c('cell', {
    appendAsTree: true,
    attrs: {
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionValueSelect === 1)
    },
    on: {
      "click": function($event) {
        _vm.onActionValueCLick(1)
      }
    }
  }, [_vm._v("关闭")])]), _c('cell', {
    appendAsTree: true,
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionValueSelect === 2)
    },
    on: {
      "click": function($event) {
        _vm.onActionValueCLick(2)
      }
    }
  }, [_vm._v("打开")])])]) : _vm._e(), (_vm.actionTargetSelect === 15) ? _c('list', {
    staticClass: ["setting-mask-action-list"]
  }, [_c('cell', {
    appendAsTree: true,
    attrs: {
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionValueSelect === 3)
    },
    on: {
      "click": function($event) {
        _vm.onActionValueCLick(3)
      }
    }
  }, [_vm._v("蓝色")]), _c('text', {
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionValueSelect === 4)
    },
    on: {
      "click": function($event) {
        _vm.onActionValueCLick(4)
      }
    }
  }, [_vm._v("黄色")]), _c('text', {
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionValueSelect === 5)
    },
    on: {
      "click": function($event) {
        _vm.onActionValueCLick(5)
      }
    }
  }, [_vm._v("紫色")]), _c('text', {
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionValueSelect === 6)
    },
    on: {
      "click": function($event) {
        _vm.onActionValueCLick(6)
      }
    }
  }, [_vm._v("青色")]), _c('text', {
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionValueSelect === 7)
    },
    on: {
      "click": function($event) {
        _vm.onActionValueCLick(7)
      }
    }
  }, [_vm._v("白色")])])]) : _vm._e(), (_vm.actionTargetSelect === 16) ? _c('list', {
    staticClass: ["setting-mask-action-list"]
  }, [_c('cell', {
    appendAsTree: true,
    attrs: {
    ...
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionValueSelect === 8)
    },
    on: {
      "click": function($event) {
        _vm.onActionValueCLick(8)
      }
    }
  }, [_vm._v("70%")]), _c('text', {
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionValueSelect === 9)
    },
    on: {
      "click": function($event) {
        _vm.onActionValueCLick(9)
      }
    }
  }, [_vm._v("80%")]), _c('text', {
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionValueSelect === 10)
    },
    on: {
      "click": function($event) {
        _vm.onActionValueCLick(10)
      }
    }
  }, [_vm._v("90%")]), _c('text', {
    staticClass: ["setting-selection-text"],
    style: {
      backgroundColor: _vm.getBgColor(_vm.actionValueSelect === 11)
    },
    on: {
      "click": function($event) {
        _vm.onActionValueCLick(11)
      }
    }
  }, [_vm._v("100%")])])]) : _vm._e()]) : _vm._e(), (_vm.isShowAction) ? _c('div', [_c('list', {
    staticStyle: {
      borderWidth: "1px",
      borderColor: "#dddddd",
      marginLeft: "16px",
  ...
  }, _vm._l((_vm.actionDataList), function(tempItem, index) {
    return _c('cell', {
      key: index,
      appendAsTree: true,
      attrs: {
    ...
    }, [_vm._v(_vm._s(_vm.getTargetStr(tempItem)) + " => " + _vm._s(_vm.getOperationStr(tempItem)))]), _c('text', {
      staticStyle: {
        padding: "20px",
        color: "#ff0000"
      },
      on: {
        "click": function($event) {
          _vm.onMaskListDataDelete(index)
        }
      }
    }, [_vm._v("删除")])])])
  }))]) : _vm._e(), (_vm.isShowInput) ? _c('div', {
    staticClass: ["setting-mask-content"],
    staticStyle: {
      justifyContent: "center",
      alignItems: "center"
  ...
  }, [_vm._v("请选择或者输入上下限 " + _vm._s(_vm.inputMin) + "-" + _vm._s(_vm.inputMax) + " ")]), _c('wxc-stepper', {
    attrs: {
      "defaultValue": _vm.inputValue,
      "max": _vm.inputMax,
      "min": _vm.inputMin
    },
    on: {
      "wxcStepperValueChanged": _vm.stepperValueChange
    }
  })], 1) : _vm._e(), _c('div', {
    staticClass: ["setting-mask-button-group"]
  }, [_c('text', {
    staticClass: ["setting-mask-button"],
    staticStyle: {
      backgroundColor: "#FFFFFF"
    },
    on: {
