...
__vue_options__.__file = "/media/creepersan/文件/毕业设计/Android/farm/src/AboutView.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3137d6e6"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	...
	data: function data() {
		return {
			//往下是图片资源
			imgLogo: _Res2.default.IMG_LOGO_DESCRIPTION,
			//往下是数据
			applicationVersion: '',
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["aboutTab"]
  }, [_c('image', {
    staticClass: ["aboutLogoImage"],
    attrs: {
      "src": _vm.imgLogo
    }
  }), _c('wxc-cell', {
    ...
    slot: "value"
  }, [_vm._v(_vm._s(this.applicationVersion))])]), _c('wxc-cell', {
    staticClass: ["aboutItem"],
    attrs: {
      "title": "版本",
      "hasTopBorder": true
    ...
    slot: "value"
  }, [_vm._v(_vm._s(this.appVersion))])]), _c('wxc-cell', {
    staticClass: ["aboutItem"],
    attrs: {
      "title": "Weex版本",
      "hasMargin": true,
    ...
    slot: "value"
  }, [_vm._v(_vm._s(this.weexVersion))])]), _c('wxc-cell', {
    staticClass: ["aboutItem"],
    attrs: {
      "title": "班级",
      "hasTopBorder": true
