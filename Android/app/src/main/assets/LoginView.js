...
__vue_options__.__file = "/media/creepersan/文件/毕业设计/Android/farm/src/LoginView.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-40ad06c2"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	...
	data: function data() {
		return {
			//　图片资源
			imgBg: _Res2.default.IMG_BACKGROUND,
			imgLogo: _Res2.default.IMG_LOGO,
			iconUserName: _Res2.default.IC_PEOPLE,
			iconPassword: _Res2.default.IC_KEY,
			imgDiver: _Res2.default.IMG_DIVER,
			// 数据
	...
	methods: {
		onLoginClick: function onLoginClick(e) {
			modal.alert({
		...
		onForgetClick: function onForgetClick(e) {
			modal.alert({
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["loginBackgroundImage"],
    style: {
      height: _vm.backgroundImageHeight
    },
    attrs: {
      "resize": "cover",
      "src": _vm.imgBg
    ...
    staticClass: ["loginDivImage"],
    attrs: {
      "resize": "contain",
      "src": _vm.imgLogo
    }
  }), _c('div', {
    staticClass: ["loginDivInputDiv"]
  }, [_c('image', {
    staticClass: ["loginDivInputDivIcon"],
    attrs: {
      "src": _vm.iconUserName
    }
  }), _c('input', {
    ref: "loginUsername",
    staticClass: ["loginDivInputDivInput"],
    attrs: {
      "type": "text",
      "placeholder": "请输入用户名"
    },
    on: {
      "input": _vm.onUserNameChange
    }
  })]), _c('div', {
    staticClass: ["loginDivInputDiv"]
  }, [_c('image', {
    ...
    staticClass: ["loginDivDiver"],
    attrs: {
      "resize": "contain",
      "src": _vm.imgDiver
    }
  }), _c('wxc-button', {
    staticClass: ["loginDivBtn"],
    attrs: {
      "text": "登录"
    },
    on: {
      "wxcButtonClicked": _vm.onLoginClick
    }
  }), _c('wxc-button', {
    staticClass: ["loginDivBtn"],
    attrs: {
    ...
    on: {
      "wxcButtonClicked": _vm.onRegisterClick
    }
  }), _c('text', {
    staticClass: ["loginDivLinkText"],
    on: {
      "click": _vm.onForgetClick
    }
  }, [_vm._v("忘记密码?")])], 1), _c('text', {
    staticClass: ["bottomText"]
  }, [_vm._v("Power by Weex")])])
},staticRenderFns: []}
module.exports.render._withStripped = true
