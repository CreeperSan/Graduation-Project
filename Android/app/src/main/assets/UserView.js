...
__vue_options__.__file = "/media/creepersan/文件/毕业设计/Android/farm/src/UserView.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-23452eac"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports = {
  ...
  "user-item-text-title": {
    "fontSize": "32",
    "fontWeight": "bold"
  },
  "user-item-text-subtitle": {
    "fontSize": "28",
    "color": "#999999",
    "marginTop": "8",
    "marginBottom": "8"
...
exports.default = {
    name: 'user-view',
    components: { WxcMinibar: _weexUi.WxcMinibar, WxcMask: _weexUi.WxcMask, WxcButton: _weexUi.WxcButton },
    mixins: [_BaseMixin2.default],
    methods: {
        // 获取资源函数
        getUserHeadImage: function getUserHeadImage(user) {
            if (user.is_admin) {
                return _Res2.default.IC_ADMIN;
            } else {
                if (user.is_staff) {
                    return _Res2.default.IC_STAFF;
                } else {
                    return _Res2.default.IC_GUEST;
                }
            }
        },
        getContextText: function getContextText(tempAccount) {
            var contentStr = '';
        ...
        onEditClick: function onEditClick(account) {
        ...
        onCreateUserClick: function onCreateUserClick() {
            this.maskUsername = '';
            this.maskNickname = '';
            this.maskPassword = '';
        ...
        onPasswordRepeatChange: function onPasswordRepeatChange(event) {
            this.maskPasswordRepeat = event.value;
        },
        onIsStaffChange: function onIsStaffChange(event) {
            this.maskIsStaff = event.value;
        },
        onIsActiveChange: function onIsActiveChange(event) {
        ...
        onConfirm: function onConfirm() {
            ...
            applicationModule.getDataBundle(function (bundle) {
                streamModule.fetch({
                    url: bundle[_Key2.default.ADDRESS] + 'api/user/',
                    method: 'POST',
                    type: 'json',
                    body: 'action_type=' + actionType + '&username=' + self.maskUsername + '&nickname=' + self.maskNickname + '&password=' + self.maskPassword + '&is_stuff=' + boolToInt(self.maskIsStaff) + '&is_active=' + boolToInt(self.maskIsActive) + '&info=' + self.maskInfo
                }, function (rec) {
                    if (rec.ok) {
                        self.refreshUser();
                    } else {
        ...
        onDelete: function onDelete() {
            ...
            applicationModule.getDataBundle(function (bundle) {
                streamModule.fetch({
                    ...
                    method: 'POST',
                    type: 'json',
                    body: 'action_type=2' + '&username=' + self.maskUsername + '&nickname=' + self.maskNickname + '&password=' + self.maskPassword + '&is_stuff=' + boolToInt(self.maskIsStaff) + '&is_active=' + boolToInt(self.maskIsActive) + '&info=' + self.maskInfo
                }, function (rec) {
                    if (rec.ok) {
                        self.refreshUser();
                    } else {
        ...
        refreshUser: function refreshUser() {
            ...
            applicationModule.getDataBundle(function (bundle) {
                streamModule.fetch({
                    url: bundle[_Key2.default.ADDRESS] + 'api/mobile_user/',
                    method: 'GET',
                    type: 'json'
                }, function (rec) {
                    self.isRefreshing = false;
                    if (rec.ok) {
                        var tempUserList = rec.data;
                        for (var i = 0; i < tempUserList.length; i++) {
                            var tempUser = tempUserList[i];
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("刷新中...")]), _c('loading-indicator')]), _vm._l((_vm.userList), function(tempUser) {
    return _c('cell', {
      key: _vm.index,
      appendAsTree: true,
      attrs: {
      ...
      staticClass: ["user-item-div"]
    }, [_c('image', {
      staticClass: ["user-item-icon"],
      attrs: {
        "src": _vm.getUserHeadImage(tempUser)
      }
    }), _c('div', {
      staticClass: ["user-item-text-div"]
    }, [_c('text', {
      staticClass: ["user-item-text-title"]
    }, [_vm._v(_vm._s(tempUser.nickname))]), _c('text', {
      staticClass: ["user-item-text-subtitle"]
    }, [_vm._v(_vm._s(tempUser.username))]), _c('text', {
      staticClass: ["user-item-text-content"]
    }, [_vm._v(_vm._s(_vm.getContextText(tempUser)))])]), (!tempUser.is_admin) ? _c('image', {
      staticClass: ["user-item-icon-edit"],
      attrs: {
        "src": _vm.icEdit
      },
      on: {
        "click": function($event) {
          _vm.onEditClick(tempUser)
        }
      }
    }) : _vm._e()])])
  })], 2), _c('wxc-mask', {
    ...
    staticClass: ["user-mask-div"]
  }, [_c('div', {
    staticClass: ["horizontal", "little-padding", "center-item", "border-round"]
  }, [_c('text', {
    staticClass: ["mask-selection-title"]
  }, [_vm._v("用户名")]), _c('input', {
    staticClass: ["match-parent"],
    attrs: {
      "value": _vm.maskUsername,
      "disabled": !_vm.maskIsCreate,
      "type": "text",
      "placeholder": "请输入用户名",
      "maxLength": "8"
    },
    on: {
      "change": _vm.onUsernameChange
    }
  })]), _c('div', {
    staticClass: ["horizontal", "little-padding", "center-item", "border-round"]
  }, [_c('text', {
    ...
    staticClass: ["match-parent"],
    attrs: {
      "value": _vm.maskNickname,
      "type": "text",
      "placeholder": "请输入用昵称,默认为用户名",
      "maxLength": "16"
    },
    on: {
      "change": _vm.onNicknameChange
    }
  })]), (_vm.maskIsCreate) ? _c('div', {
    staticClass: ["horizontal", "little-padding", "center-item", "border-round"]
  }, [_c('text', {
    staticClass: ["mask-selection-title"]
  }, [_vm._v("密码")]), _c('input', {
    staticClass: ["match-parent"],
    attrs: {
      "value": _vm.maskPassword,
      "type": "password",
      "placeholder": "请输入密码",
      "maxLength": "16"
    },
    on: {
      "change": _vm.onPasswordChange
    }
  })]) : _vm._e(), (_vm.maskIsCreate) ? _c('div', {
    staticClass: ["horizontal", "little-padding", "center-item", "border-round"]
  }, [_c('text', {
    staticClass: ["mask-selection-title"]
  }, [_vm._v("重复密码")]), _c('input', {
    staticClass: ["match-parent"],
    attrs: {
      "value": _vm.maskPasswordRepeat,
      "type": "password",
      "placeholder": "请再次确认密码",
      "maxLength": "16"
    },
    on: {
      "change": _vm.onPasswordRepeatChange
    }
  })]) : _vm._e(), _c('div', {
    staticClass: ["horizontal", "little-padding", "center-item", "border-round"]
  }, [_c('text', {
    staticClass: ["mask-selection-title"]
  }, [_vm._v("是否工作人员")]), _c('switch', {
    attrs: {
      "checked": _vm.maskIsStaff
    },
    on: {
      "change": _vm.onIsStaffChange
    }
  })]), _c('div', {
    staticClass: ["horizontal", "little-padding", "center-item", "border-round"]
  }, [_c('text', {
    staticClass: ["mask-selection-title"]
  }, [_vm._v("是否正在活动")]), _c('switch', {
    attrs: {
      "checked": _vm.maskIsActive
    },
    on: {
      "change": _vm.onIsActiveChange
    }
  })]), _c('div', {
