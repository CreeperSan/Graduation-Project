...
$(document).ready(function(){
    ...
    $('#auto_temp').on('switchChange.bootstrapSwitch', function (event,state) {
        ajaxPost(
            URL_TEMPERATURE,
    ...
    $('#auto_humidity').on('switchChange.bootstrapSwitch', function (event,state) {
        ajaxPost(
            URL_HUMIDITY,
            {'is_auto_control':Number($(this).bootstrapSwitch('state'))},
            function (){},
    ...
    $('#id_dirt_humidity').on('switchChange.bootstrapSwitch', function (event,state) {
        ajaxPost(
            URL_DIRT_HUMIDITY,
            {'is_auto_control':Number($(this).bootstrapSwitch('state'))},
            function (){},
